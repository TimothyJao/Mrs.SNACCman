class GridCell {
    ...
    canMoveUp() {
        if ((this.y === 0) || this.grid[this.x][this.y-1] ==="X") {
            return false;
        } else {
            return true;
        }
    ...
    canMoveDown() {
        if ((this.y === this.grid.length - 1) || this.grid[this.x][this.y+1] === "X") {
            return false;
        } else {
            return true;
        }
    ...
    canMoveRight() {
        if ((this.x === this.grid[0].length - 1 || this.grid[this.x+1][this.y] === "X")){
            return false;
        } else {
            return true;
        }
